  ...
  const rows =
    family !== "all" && report?.byScenario
      ...
      : optimized && report?.optimizedSummaries
        ...
        : report?.summaries;
  return (
    <details className="historical-disclosure">
      <summary>Historical evidence · TACIT 0.3</summary>
        ...
        <div className="evidence-heading">
          <div>
            ...
            <p>
              ...
              These saved results are retained under their original model; they
              do not describe the current controller.
            </p>
          </div>
          {report && (
            <div
        ...
        {report && rows ? (
          <>
            <div className="evidence-scope">
              ...
              <span>
                Means include every run, including stops. Target: ≤162 µL with
                no recorded violation.
              </span>
            </div>
            <p className="table-scroll-hint">
              Scroll horizontally to inspect all historical measures.
            </p>
            <div
              className="evidence-scroll"
              tabIndex={0}
              role="region"
              aria-label="Historical outcomes table; scroll horizontally for all metrics"
            >
                  ...
                  {rows.map((s) => (
                    <tr key={s.controller}>
                      ...
                      <td>
                        ...
                        {s.remainingCI && (
                          <small>
                            {s.remainingCI.map((x) => x.toFixed(1)).join("–")}{" "}
                            µL
                          </small>
                        )}
                      </td>
                      ...
                      <td>
                        ...
                        {!!s.missedTargets && (
                          <small>
                            {s.missedTargets} declared done but missed the
                            target
                          </small>
                        )}
                        <small>
            ...
            <div className="evidence-footnote">
              <p>
                ...
                figures are 95% confidence intervals: bootstrap for means,
                ...
                {report.stress.rejected.toLocaleString()} paths rejected.
              </p>
